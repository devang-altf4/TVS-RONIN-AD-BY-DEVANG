...
const BookingSection: React.FC = () => {
    return (
        <section className="py-32 bg-red-950/20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="max-w-4xl mx-auto border border-red-900/50 bg-black/50 backdrop-blur-sm p-12 md:p-20"
                >
                    ...
                    <div className="flex flex-col md:flex-row gap-6 justify-center">
                        <button className="px-10 py-5 bg-red-600 text-white text-lg font-bold uppercase tracking-widest hover:bg-red-700 transition-colors shadow-[0_0_20px_rgba(220,38,38,0.5)]">
                            Book Now
                        </button>
                        <button className="px-10 py-5 border border-white text-white text-lg font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-colors">
                            Book Test Ride
                        </button>
                    </div>
                </motion.div>
